  ...
  >
    <el-main>
      <el-container style="height: 100%" :key="locale && locale.name">
        ...
        <el-aside
          class="_fc-l"
          :width="activeModule === 'language' ? '450px' : '266px'"
        >
                  ...
                  >
                    <div class="_fc-tree-label">
                      ...
                      <span>{{
                        ...
                        t(
                          "com." +
                            (data.rule._menu && data.rule._menu.name) +
                            ".name"
                        ) ||
                        data.rule.type
                      }}</span>
          ...
          <el-container style="height: 100%">
            <el-header height="40px" class="_fc-r-tabs">
              ...
              <div
                ...
                :class="{
                  active:
                    activeTab === 'form' && (!!activeRule || customForm.isShow),
                }"
            ...
            >
              ...
              <template
                v-if="
                  activeRule ||
                  (customForm.config &&
                    (customForm.config.name || customForm.config.label))
                "
              >
              ...
              >
                <div style="grid-area: base">
                  <el-divider v-if="baseForm.isShow">{{
                    t("designer.rule")
                  }}</el-divider>
                  <DragForm
        ...
        >
          ...
          <div
            ...
            v-if="['component', 'html'].indexOf(previewStatus) > -1"
            @click="copyCode"
          >
  ...
  setup(props) {
    ...
    const methods = {
      ...
      inputSave() {
        ...
        const flag =
          JSON.stringify(data.inputForm.data) !== JSON.stringify(formData);
      ...
      inputReset(formData) {
        ...
        data.inputForm.option.formData =
          formData || deepCopy(data.inputForm.data);
      ...
      openPreview() {
        ...
        data.preview.html = hljs.highlight(htmlTemplate(rule, options), {
          language: "xml",
        }).value;
      },
      copyCode() {
      ...
      updateRuleFormData() {
        ...
        if (data.baseForm.isShow) {
          ...
          data.dragForm.api.refreshValidate();
          data.dragForm.api.nextTick(() => {
            console.log(data.dragForm.api, " data.dragForm.api");
